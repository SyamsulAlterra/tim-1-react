...
class News extends React.Component {
  ...
  render() {
    ...
    if (this.props.search === "") {
      ...
      this.props.search !== "" ||
      this.props.search.toLowerCase() === "premier league" ||
      "inggris" ||
      "premier" ||
      "england"
    ) {
      return (
        <div>
          {this.props.news.map((value, index) => {
            if (
              (index < 4 && value.title.includes(this.props.search)) ||
      ...
      (this.props.search !== "" &&
        this.props.search.toLowerCase() === "ligue one") ||
      "perancis" ||
      "prancis" ||
      "france"
    ) {
      return (
        <div>
          {this.props.newsFer.map((value, index) => {
            if (
              index < 4 &&
      ...
      (this.props.search !== "" &&
        this.props.search.toLowerCase() === "serie a") ||
      "series a" ||
      "itali" ||
      "italy"
    ) {
      return (
        <div>
          {this.props.newsIt.map((value, index) => {
            if (
              index < 4 &&
              value.title.includes(this.props.search) &&
              value.url.includes("football")
